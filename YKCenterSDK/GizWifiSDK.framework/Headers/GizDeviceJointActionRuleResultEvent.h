...
@property (strong, nonatomic, readonly) NSDictionary * _Nullable data;
 ...
 */
+ (id _Nullable)jointActionRuleResultEventByDevice:(GizWifiDevice * _Nonnull)device data:(NSDictionary * _Nonnull)data;
 ...
 */
+ (id _Nullable)jointActionRuleResultEventByGroup:(GizDeviceGroup * _Nonnull)group data:(NSDictionary * _Nonnull)data;
