 ...
 */
+ (instancetype _Nullable)schedulerTaskWithDevice:(GizWifiDevice * _Nonnull)device data:(NSDictionary * _Nonnull)data;
 ...
 */
+ (instancetype _Nullable)schedulerTaskWithGroup:(GizDeviceGroup * _Nonnull)group data:(NSDictionary * _Nonnull)data;
...
@property (strong, nonatomic) NSDictionary * _Nullable data;
