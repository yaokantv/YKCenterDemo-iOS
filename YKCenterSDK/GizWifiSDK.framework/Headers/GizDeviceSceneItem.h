 ...
 */
+ (instancetype _Nullable)sceneItemWithDevice:(GizWifiDevice * _Nonnull)device data:(NSDictionary * _Nonnull)data;
 ...
 */
+ (instancetype _Nullable)sceneItemWithGroup:(GizDeviceGroup * _Nonnull)group data:(NSDictionary * _Nonnull)data;
